      ...
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        <SwiperSlide>
          <img
            ...
            alt=""
          />
          <div className="absolute top-4 lg:top-36 text-center text-white">
            <p className="lg:text-xl font-medium">Essential Accessories</p>
            <h1 className="lg:text-7xl font-bold">Golden Charms</h1> <br />
            <div className="lg:px-40">
              <hr className="border-2 border-black" />
            </div>
            <p className="px-10 lg:px-40 lg:py-5 lg:font-medium text-white">
        ...
        <SwiperSlide>
          <img
            ...
            alt=""
          />
          <div className="absolute top-4 lg:top-36 text-center text-black">
            <p className="lg:text-xl font-medium">Hot of the season</p>
            <h1 className="lg:text-7xl font-bold">Jewelry Shop</h1> <br />
            <div className="lg:px-40">
              <hr className="border-2 border-black" />
            </div>
            <p className="px-10 lg:px-40 lg:py-5 font-medium text-black">
        ...
        <SwiperSlide>
          ...
          />
          <div className="absolute top-4 lg:top-36 text-center text-black">
            <p className="lg:text-xl font-medium">Ultimate ring models</p>
        ...
        <SwiperSlide>
          ...
          <div className="absolute top-4 lg:top-36 text-center text-white">
            ...
            <p className="px-10 lg:px-40 lg:py-5 font-medium text-white">
              Our new spring collection model are based on the latest fashion
              trend. Refresh your style and create a new image with golden
              charms.
            </p>
