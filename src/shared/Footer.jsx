    ...
    <div>
      <footer className="footer p-4 lg:p-10 bg-base-200 text-base-content">
        ...
        <nav>
          ...
          <p>
            <span className="font-semibold font-serif">Mobile:</span>{" "}
            +8801234567899
          </p>
          <p>
            <span className="font-semibold font-serif">Email:</span>{" "}
            thecenterstone@gmail.com
          </p>
          <p>
            <span className="font-semibold font-serif">Open:</span> Sunday To
            Thursday
          </p>
          <p>
            <span className="font-semibold font-serif">Location:</span> Dhaka,
            Bangladesh
          </p>
        </nav>
      </footer>
      <footer className="footer items-center p-4 bg-yellow-500 text-black">
        <aside className="items-center grid-flow-col">
          <img src="/Image/logo.png" className="w-16" alt="" />

          <p>
            <span className="text-xl font-bold font-serif">
              The Center Stone
            </span>{" "}
            <br /> Copyright © 2023 - All right reserved
          </p>
        </aside>
